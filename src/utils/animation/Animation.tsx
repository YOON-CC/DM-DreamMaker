...
const Animation: React.FC<LoadButtonProps> = ({ canvas }) => {
  const handleSetElementName1 = () => {
    // 제자리에서 사라졌다 나오는 애니메이션
    if (canvas) {
  ...
  const handleSetElementName2 = () => {
    // 아래=>위 올라오며 사라졌다 나오는 애니메이션
    if (canvas) {
      const activeObject = canvas.getActiveObject();
  ...
  const handleSetElementName3 = () => {
    // 왼=>오 방향에서 사라졌다 나오는 애니메이션
    if (canvas) {
      const activeObject = canvas.getActiveObject();
  ...
  const handleSetElementName4 = () => {
    // 오=>왼 방향에서 사라졌다 나오는 애니메이션
    if (canvas) {
      const activeObject = canvas.getActiveObject();
  ...
  const handleSetElementName5 = () => {
    // 위=>아래 방향으로 사라졌다 나오는 애니메이션
    if (canvas) {
      const activeObject = canvas.getActiveObject();
